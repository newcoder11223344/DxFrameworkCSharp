...
namespace DxFramework.FrameWork
{
    ...
    class Canvas : AutoDrawnBase,IMouseObjectBase
    {
        public Canvas(int layer)
            : this(layer, new Vector2(1, 1), new Vector2(100, 50))
        { }

        public Canvas(int layer, Vector2 top, ICanvasMaterialBase canvas)
            : base(layer)
        {
            Top = top;
            Material = canvas;
        ...
        public Canvas(int layer, Vector2 top, Vector2 size)
            : base(layer)
        {
        ...
        public ICanvasMaterialBase Material { get; set; }            // 描画対象
        ...
        public virtual Vector2 Size                        // 左上を基準にしたサイズ
        {
            ...
            set
            {
                Material.Size = new Vector2(Material.Size.x * value.x / _size.x, Material.Size.y * value.y / _size.y);
                _size = value;
            }
        }
